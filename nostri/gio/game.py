...
# PATH MODELLO
MODEL_PATH = r"best_rps_model.pth"
...
class RPSNet(nn.Module):
    def __init__(self):
        ...
        self.net = nn.Sequential(
            ...
            nn.ReLU(),
            nn.MaxPool2d(2),
            nn.AdaptiveAvgPool2d((7,7)),  # forza output 64x7x7
            nn.Flatten(),
...
# voto finale = maggioranza
    player_move = CLASSES[max(set(pred_buffer), key=pred_buffer.count)]
